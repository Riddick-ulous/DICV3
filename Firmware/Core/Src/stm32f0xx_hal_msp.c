...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  ...
  /* USER CODE END SPI1_MspDeInit 0 */
    ...
    PA7     ------> SPI1_MOSI
    */
    HAL_GPIO_DeInit(GPIOA, SPI1_SCK_Display_Pin|SPI1_MOSI_Display_Pin);
  ...
  /* USER CODE END SPI2_MspDeInit 0 */
    ...
    PB10     ------> SPI2_SCK
    */
    HAL_GPIO_DeInit(SPI2_MOSI_RGBLED_GPIO_Port, SPI2_MOSI_RGBLED_Pin);

    HAL_GPIO_DeInit(SPI2_SCK_RGBLED_GPIO_Port, SPI2_SCK_RGBLED_Pin);
